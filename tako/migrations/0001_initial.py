    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.ForeignKey(help_text='The job that this execution relates to.', on_delete=django.db.models.deletion.CASCADE, to='tako.djangojob')),
            ],
            options={
                'ordering': ('-run_time',),
                'constraints': [models.UniqueConstraint(fields=('job_id', 'run_time'), name='unique_job_executions')],
            },
        ),
    ]
